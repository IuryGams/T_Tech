...
import { BoxOptions, BoxPrice, Container, DescriptionProduct, FullPrice, OldPrice, PriceProduct, StockBox, TitleProduct } from "./styled";
...
export default function ProductBody({ product, colorOption, sizeOption, color, setColor }: {
    ...
    return (
        <Container>
            ...
            <HorizontalDash styles={{ width: "100%", marginTop: "10px" }} />
        </Container>
    )
}